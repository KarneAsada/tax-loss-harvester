...
1.  **Branching**:
    -   **CRITICAL**: You MUST create a new branch for EVERY new task or feature request. NEVER work directly on `main`.
...
3.  **Submission**:
    -   When changes are complete, you MUST create a Pull Request (PR) and push the changes to GitHub.
